    ...
    <div className="advanced-filters">
      ...
      {isOpen && (
        <div className="numeric-filter-builder">
          ...
          <div className="numeric-filter-actions"><button className="clear-filter" onClick={() => setIsOpen(false)}>Hủy</button><button className="primary-button compact-button" disabled={!canAdd} onClick={handleAdd}>Áp dụng</button></div>
