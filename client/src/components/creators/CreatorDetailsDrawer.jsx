...
export default function CreatorDetailsDrawer({ creator, onClose, onArchive }) {
    ...
    <div className="drawer-layer">
      ...
      <aside className="creator-drawer">
        ...
        <section className="profile-section">
          <div className="section-title"><h4>Thông tin Creator</h4><button><Icon name="edit" size={15} /> Chỉnh sửa</button></div>
        ...
        <div className="drawer-actions"><button className="secondary-button"><Icon name="edit" />Chỉnh sửa hồ sơ</button><button className="danger-text-button" onClick={() => onArchive(creator.id)}><Icon name="archive" />{creator.status === 'Archived' ? 'Khôi phục' : 'Lưu trữ'}</button></div>
      </aside>
    </div>
  )
}
